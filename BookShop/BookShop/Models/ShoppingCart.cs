...
namespace BookShop.Models
{
    public class ShoppingCart:IShoppingCart
    {
        ...
        private ShoppingCart(YvanPieShopDbContext bethanysPieShopDbContext)
        {
        ...
        public static ShoppingCart GetCart(IServiceProvider services)
        {
            ...
            YvanPieShopDbContext context = services.GetService<YvanPieShopDbContext>() ?? throw new Exception("Error initializing");
